...
<div id="slider" class="ls-wp-container fitvidsignore hero-5 th-hero-carousel"
    ...
    style="width:1920px;height:720px;margin-top:0;margin-bottom: 0px;{{ $background ? 'background-image:url(\'' . $background->getFirstMediaUrl('publicite_image', 'background') . '\');background-size:cover;background-position:center;' : '' }}">
            ...
            Welcome to Pizzan
                ...
                <picture>
                    ...
                    <img width="800" height="800" src="{{ $item->getFirstMediaUrl('publicite_image') }}"
                        ...
                        style="font-size:36px; color:#000; text-align:left; font-style:normal; text-decoration:none; text-transform:none; font-weight:400; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; left:1000px; top:0px;"
                ...
                @if ($item['button_name'])
                    <a style="" class="ls-l ls-hide-tablet ls-hide-phone" href="{{ $item['url'] }}"
                        ...
                        <ls-layer
                            style="font-size:14px; color:#fff; text-align:center; font-family:Rubik; cursor:pointer; width:180px; left:344px; top:442px; text-transform:uppercase; line-height:14px; padding-bottom:20px; padding-top:22px; font-weight:600; border-radius:4px 4px 4px 4px; background-color:#f85d05;"
                ...
                @if ($item['button_name'])
                    <a style="" class="ls-l ls-hide-desktop" href="{{ $item['url'] }}" target="_self"
                        ...
                        <ls-layer
                            style="font-size:32px;  color:#fff; text-align:center; font-family:Rubik; cursor:pointer; left:308px; top:390px; text-transform:uppercase; padding-bottom:30px; padding-top:30px; font-weight:600; line-height:50px; margin:20px; background-color:#f85d05; border-radius:10px 10px 10px 10px; width:370px;"
