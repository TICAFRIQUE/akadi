                ...
                @foreach ($product as $item)
                    ...
                    <div class="th-product">
                        ...
                        <div class="product-content">
                            <a href="/produit?categorie={{$item['categories'][0]['id']}}" class="category">{{$item['categories'][0]['name']}}</a>
                            ...
                            <h3 class="product-title"><a href="{{route('detail-produit', $item['slug'])}}"> {{$item['title']}} </a></h3>
