...
@section('sub-title', 'Ajouter un produit de base')
                ...
                <div class="col-12 col-md-8 offset-md-2">
                    <div class="card">
                        <div class="card-header">
                            <h4>Ajouter un produit de base</h4>
                        </div>

                        @include('admin.components.validationMessage')

                        <form action="{{ route('product-base.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="nom" 
                                           value="{{ old('nom') }}" 
                                           placeholder="Ex: Poulet, Huile, Oignons..."
                                           required>
                                    @error('nom')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @error('stock')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">Le stock sera géré automatiquement par les achats</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @error('stock_alerte')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">Alerte quand le stock est en dessous</small>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('unite') is-invalid @enderror" 
                                                ...
                                                <option value="gramme" {{ old('unite') == 'gramme' ? 'selected' : '' }}>Gramme</option>
                                                <option value="ml" {{ old('unite') == 'ml' ? 'selected' : '' }}>Millilitre (ml)</option>
                                                <option value="sachet" {{ old('unite') == 'sachet' ? 'selected' : '' }}>Sachet</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   value="{{ old('prix_achat_moyen', 0) }}" 
                                                   step="1" 
                                                   min="0">
                                            @error('prix_achat_moyen')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">Sera calculé automatiquement selon les achats</small>
                                        </div>
                                    </div>
                                </div>
