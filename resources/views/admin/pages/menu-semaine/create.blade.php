                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('menu-semaine.store') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="titre" class="form-control" placeholder="Ex : Semaine du 3 au 8 août" value="{{ old('titre') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <small class="text-muted d-block mt-1">Les jours ci-dessous se génèrent automatiquement selon cet intervalle.</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="seuil_jours" class="form-control" min="1" value="{{ old('seuil_jours', 3) }}" required>
                            ...
                            <div id="jours-container">
                                <p class="text-muted" id="jours-placeholder">Choisissez une période ci-dessus pour afficher les jours.</p>
                            </div>
...
<script>
    ...
    function buildPlatRow(dateKey, nom, description, prixNormal, prixReduit) {
    ...
    function addPlatRow(dateKey, nom = '', description = '', prixNormal = '', prixReduit = '') {
        const container = document.getElementById('plats-body-' + dateKey);
        if (!container) return;
        const row = buildPlatRow(dateKey, nom, description, prixNormal, prixReduit);
    ...
    function buildJourCard(dateKey, label) {
        const div = document.createElement('div');
    ...
    function rebuildJours() {
        ...
        while (cur <= fin) {
            ...
            const label = cur.toLocaleDateString('fr-FR', { weekday: 'long', day: '2-digit', month: '2-digit', year: 'numeric' });
            container.appendChild(buildJourCard(dateKey, label.charAt(0).toUpperCase() + label.slice(1)));
