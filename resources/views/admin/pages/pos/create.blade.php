...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#product-select").on("change", function() {
                ...
                var p = {
                    ...
                    stock: rawStock !== "" && rawStock !== undefined && !isNaN(rawStock) ? parseInt(
                        rawStock) : null,
            ...
            <td style="width:100px; padding-left:20px">
                <div class="input-group input-group-sm" style="width:96px;flex-wrap:nowrap">
                    ...
                    <input type="number" name="menu_produits[${m.id}][quantity]"
                        class="form-control form-control-sm qty-input text-center"
                        style="min-width:56px" value="1" min="1"
            ...
            <td style="width:150px; padding-left:35px">
                <div class="input-group input-group-sm" style="width:140px;flex-wrap:nowrap">
                    <input type="number" name="menu_produits[${m.id}][discount]"
                        class="form-control form-control-sm discount-input text-center"
                        style="min-width:100px" value="0" min="0" max="100" step="1"
                        onchange="recalcRow('${key}')">
                    <div class="input-group-append">
                        <button type="button" class="btn type-disc-btn type-disc-pct active-pct"
                    ...
                    <input type="hidden" name="menu_produits[${m.id}][type_discount]" class="type-discount-input" value="percent">
                </div>
            </td>
            <td class="text-right">
                <span id="total-${key}" class="font-weight-bold">${formatMoney(m.price)} FCFA</span>
            </td>
            <td class="text-center">
                <button type="button" class="btn btn-sm btn-outline-danger btn-remove-row"
        ...
        function setGlobalDiscountType(type, btn) {
            document.querySelectorAll(".global-disc-btn").forEach((b) =>
                b.classList.remove("active-pct", "active-fixed")
            );
