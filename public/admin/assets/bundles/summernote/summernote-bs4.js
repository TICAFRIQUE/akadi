...
(function (global, factory) {
    ...
    var toolbar = renderer.create(
        '<div class="note-toolbar-wrapper"><div class="note-toolbar card-header"></div></div>'
    );
    ...
    function isVoid(node) {
        return (
            node &&
            /^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT/.test(
    ...
    var Style = /** @class */ (function () {
        ...
        Style.prototype.current = function (rng) {
            ...
            if (!rng.isOnList()) {
                ...
                var isUnordered =
                    $$1.inArray(styleInfo["list-style-type"], orderedTypes) >
                    -1;
        ...
        Table.prototype.addRow = function (rng, position) {
                    ...
                    case TableResultAction.resultAction.SumSpanCount:
                        if (position === "top") {
                            ...
                            var isTopFromRowSpan =
                                (!baseCellTr
                                    ? 0
                                    : currentCell.baseCell.closest("tr")
                                          .rowIndex) <= currentTr[0].rowIndex;
                            if (isTopFromRowSpan) {
                                var newTd = $$1("<div></div>")
                                    .append(
                                        $$1(
            ...
            if (position === "top") {
                ...
                if (cellHasRowspan) {
                    ...
                    $$1($$1(currentTr).parent().find("tr")[lastTrIndex]).after(
                        $$1(html)
                    );
                    return;
                }
                    ...
                    case TableResultAction.resultAction.AddCell:
                        ...
                        if (hasRowspan) {
                            if (rowspanNumber > 2) {
                                ...
                                nextRow.cells[cellPos].removeAttribute(
                                    "rowSpan"
                                );
                                nextRow.cells[cellPos].innerHTML = "";
                            }
            ...
            if (rng) {
                ...
                if (rng.isCollapsed()) {
                    ...
                    if (firstSpan && !dom.nodeLength(firstSpan)) {
                        ...
                        range
                            .createFromNodeAfter(firstSpan.firstChild)
                            .select();
        ...
        Buttons.prototype.addToolbarButtons = function () {
                        ...
                        _this.ui.dropdown({
                            ...
                            template: function (item) {
                                if (typeof item === "string") {
                                    item = {
                                        tag: item,
                                        title: _this.lang.style.hasOwnProperty(
                                            item
                                        )
            ...
            this.context.memo("button.bold", function () {
                return _this
                    .button({
                        ...
                        tooltip:
                            _this.lang.font.bold +
                            _this.representShortcut("bold"),
            ...
            this.context.memo("button.superscript", function () {
                return _this
                    .button({
                        ...
                        contents: _this.ui.icon(
                            _this.options.icons.superscript
                        ),
            ...
            this.context.memo("button.ol", function () {
                return _this
                    .button({
                        contents: _this.ui.icon(
                            _this.options.icons.orderedlist
                        ),
                        tooltip:
                        ...
                        ],
                        {
                            callback: function ($node) {
                                ...
                                $catcher
                                    .css({
                                        width:
                                            _this.options.insertTableMaxSize
                                                .col + "em",
                                        height:
                                            _this.options.insertTableMaxSize
                                                .row + "em",
        ...
        Buttons.prototype.addImagePopoverButtons = function () {
            ...
            this.context.memo("button.floatNone", function () {
                return _this
                    .button({
                        contents: _this.ui.icon(
                            _this.options.icons.alignJustify
                        ),
