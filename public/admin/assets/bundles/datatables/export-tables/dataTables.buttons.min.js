                ...
                if (j)
                    if (d.isArray(j)) this._expandButton(a, j, c, e);
                        ...
                        if (p) {
                            ...
                            j.init &&
                                j.init.call(g.button(p.node), g, d(p.node), j);
                            h++;
                        }
                    }
            }
    ...
    i.Api.register("buttons.exportData()", function (a) {
        if (this.context.length) {
            ...
            b.select &&
                ...
                h.selected === m &&
                b.rows(c.rows, d.extend({ selected: !0 }, h)).any() &&
                d.extend(h, { selected: !0 });
            for (
                var h = b.rows(c.rows, h).indexes().toArray(),
                ...
                for (var r = [k], s = 0; s < k; s++)
                    (r[s] = c.format.body(h[l], n, s, f[l])), l++;
                j[n] = r;
            }
            a = {
                header: a,
